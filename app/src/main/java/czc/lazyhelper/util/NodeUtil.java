...
public class NodeUtil {
    ...
    public static boolean findNodeByIdAndClick(AccessibilityNodeInfo root, String id, String text, boolean isNewPage) {
        if (root == null) {
            return false;
        }
    ...
    public static boolean findNodeByIdAndClick2(AccessibilityNodeInfo root, String id, String className, boolean isNewPage) {
        if (root == null) {
            return false;
        }
        List<AccessibilityNodeInfo> idNodeInfoList = root.findAccessibilityNodeInfosByViewId(id);
